...
define i16 @or16_reg_imm_0xff00(i16 %a) addrspace(1) {
...
define i16 @or16_reg_imm_0xffb3(i16 %a) addrspace(1) {
...
define i16 @or16_reg_imm_0x00ff(i16 %a) addrspace(1) {
...
define i16 @or16_reg_imm_0xb3ff(i16 %a) addrspace(1) {
