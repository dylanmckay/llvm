...
define i8 @atomic_swap8(i8* %foo) addrspace(1) {
...
define i16 @atomic_swap16(i16* %foo) addrspace(1) {
...
define i32 @atomic_swap32(i32* %foo) addrspace(1) {
...
define i64 @atomic_swap64(i64* %foo) addrspace(1) {
