...
define void @atomic_store8(i8* %foo) addrspace(1) {
...
; CHECK-NEXT: out 63, r0
define void @atomic_store16(i16* %foo) addrspace(1) {
...
define void @atomic_store32(i32* %foo) addrspace(1) {
...
define void @atomic_store64(i64* %foo) addrspace(1) {
