...
define i16 @atomic_load16(i16* %foo) addrspace(1) {
...
define i16 @atomic_load_swap16(i16* %foo) addrspace(1) {
...
define i16 @atomic_load_cmp_swap16(i16* %foo) addrspace(1) {
...
; CHECK-NEXT: out 63, r0
define i16 @atomic_load_add16(i16* %foo) addrspace(1) {
...
; CHECK-NEXT: std [[RD1]]+1, [[A:r[0-9]+]]
; CHECK-NEXT: out 63, r0
define i16 @atomic_load_sub16(i16* %foo) addrspace(1) {
...
; CHECK-NEXT: std [[RD1]]+1, [[A:r[0-9]+]]
; CHECK-NEXT: out 63, r0
define i16 @atomic_load_and16(i16* %foo) addrspace(1) {
...
; CHECK-NEXT: std [[RD1]]+1, [[A:r[0-9]+]]
; CHECK-NEXT: out 63, r0
define i16 @atomic_load_or16(i16* %foo) addrspace(1) {
...
; CHECK-NEXT: std [[RD1]]+1, [[A:r[0-9]+]]
; CHECK-NEXT: out 63, r0
define i16 @atomic_load_xor16(i16* %foo) addrspace(1) {
...
define i16 @atomic_load_nand16(i16* %foo) addrspace(1) {
...
define i16 @atomic_load_max16(i16* %foo) addrspace(1) {
...
define i16 @atomic_load_min16(i16* %foo) addrspace(1) {
...
define i16 @atomic_load_umax16(i16* %foo) addrspace(1) {
...
define i16 @atomic_load_umin16(i16* %foo) addrspace(1) {
