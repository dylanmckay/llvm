...
define void @write8() addrspace(1) {
; CHECK-LABEL: write8
; CHECK: out 8
...
define void @write16() addrspace(1) {
; CHECK-LABEL: write16
; CHECK: out 9
; CHECK: out 8
...
define void @write32() addrspace(1) {
; CHECK-LABEL: write32
; CHECK: out 11
; CHECK: out 10
; CHECK: out 9
...
define void @write64() addrspace(1) {
; CHECK-LABEL: write64
; CHECK: out 15
; CHECK: out 14
; CHECK: out 13
