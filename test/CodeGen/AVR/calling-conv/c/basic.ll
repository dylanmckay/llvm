...
define void @ret_void_args_i8(i8 %a) addrspace(1) {
  ; CHECK: sts 4, r24
...
define void @ret_void_args_i8_i32(i8 %a, i32 %b) addrspace(1) {
  ; CHECK:      sts     4, r24
  store volatile i8 %a, i8* inttoptr (i64 4 to i8*)
...
define void @ret_void_args_i8_i8_i8_i8(i8 %a, i8 %b, i8 %c, i8 %d) addrspace(1) {
  ; CHECK:      sts     4, r24
  store volatile i8 %a, i8* inttoptr (i64 4 to i8*)
...
define void @ret_void_args_i32_16_i8(i32 %a, i16 %b, i8 %c) addrspace(1) {
  ; CHECK:      sts     7, r25
...
define void @ret_void_args_i64(i64 %a) addrspace(1) {
  ; CHECK:      sts     11, r25
...
define void @ret_void_args_i64_i64(i64 %a, i64 %b) addrspace(1) {
  ; CHECK:      sts     11, r25
  ; CHECK-NEXT: sts     10, r24
  ; CHECK-NEXT: sts     9, r23
  ; CHECK-NEXT: sts     8, r22
...
define void @ret_void_args_i64_i64_i16(i64 %a, i64 %b, i16 %c) addrspace(1) {
  ; CHECK:      sts     5, r9
  ; CHECK-NEXT: sts     4, r8
