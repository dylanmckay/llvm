...
define void @no_operands() addrspace(1) {
...
define void @input_operand(i8 %a) addrspace(1) {
  ; CHECK: add {{r[0-9]+}}, {{r[0-9]+}}
...
define void @simple_upper_regs(i8 %p0, i8 %p1, i8 %p2, i8 %p3addrspace(1) ,
                               i8 %p4, i8 %p5, i8 %p6, i8 %p7) addrspace(1) {
...
define void @upper_regs(i8 %p0) addrspace(1) {
...
define void @lower_regs(i8 %p0) addrspace(1) {
  ; CHECK: some_instr {{r[0-9]+}}
...
define void @special_upper_regs(i8 %p0, i8 %p1, i8 %p2, i8 %p3) addrspace(1) {
...
; CHECK-LABEL: xyz_reg:
define void @xyz_reg(i16 %var) addrspace(1) {
...
; CHECK-LABEL: ptr_reg:
define void @ptr_reg(i16 %var0, i16 %var1, i16 %var2) addrspace(1) {
  ; CHECK: some_instr {{r[0-9]+}}, {{r[0-9]+}}, {{r[0-9]+}}
...
define void @base_ptr_reg(i16 %var0, i16 %var1) addrspace(1) {
...
define i8 @input_output_operand(i8 %a, i8 %b) addrspace(1) {
  ; CHECK: add {{r[0-9]+}}, {{r[0-9]+}}
...
define void @temp_reg(i8 %a) addrspace(1) {
  ; CHECK: some_instr {{r[0-9]+}}
...
define void @int_0_63() addrspace(1) {
  ; CHECK: some_instr 5
...
define void @int_minus63_0() addrspace(1) {
  ; CHECK: some_instr -5
...
; CHECK-LABEL: int_2_2:
define void @int_2_2() addrspace(1) {
  ; CHECK: some_instr 2
...
; CHECK-LABEL: int_0_0:
define void @int_0_0() addrspace(1) {
  ; CHECK: some_instr 0
...
define void @int_0_255() addrspace(1) {
...
define void @int_minus1_minus1() addrspace(1) {
  ; CHECK: some_instr -1
...
define void @int_8_or_16_or_24() addrspace(1) {
...
; CHECK-LABEL: int_1_1:
define void @int_1_1() addrspace(1) {
  ; CHECK: some_instr 1
...
define void @int_minus6_5() addrspace(1) {
  ; CHECK: some_instr -6
...
define void @float_0_0() addrspace(1) {
  ; CHECK: some_instr 0
...
define void @mem_global() addrspace(1) {
...
define void @mem_params(i16* %a, i16* %b) addrspace(1) {
  ; CHECK: some_instr {{X|Y|Z}}, {{X|Y|Z}}
  call void asm "some_instr $0, $1", "=*Q,=*Q"(i16* %a, i16* %b)
  ret void
}
...
define void @mem_local() addrspace(1) {
  %a = alloca i16
  %b = alloca i16
...
define void @mem_mixed() addrspace(1) {
  %a = alloca i16
  %b = alloca i16
...
; CHECK-LABEL: mem_gep:
define i8 @mem_gep(i8* %p) addrspace(1) {
entry:
